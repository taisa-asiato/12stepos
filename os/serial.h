...
int serial_intr_is_send_enable(int index);		// 送信割込み可能か？
void serial_intr_send_enable(int index);		// 送信割込み有効化
void serial_intr_send_disable(int index); 		// 送信割込み無効化
int serial_intr_is_recv_enable(int index);		// 受信割込み可能か？
void serial_intr_recv_enable(int index);		// 割込み有効化
void serial_intr_recv_disable(int index);		// 割込み無効化
